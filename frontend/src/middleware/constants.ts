...
export const REGISTERED_MERCHANTS = [
  { name: 'Test Merchant', address: '0x3C44CdDdB6a900fa2b585dd299e03d12FA4293BC' as `0x${string}` },
  { name: 'Official Store', address: '0x90F79bf6EB2c4f870365E785982E1f101E93b906' as `0x${string}` },
];
